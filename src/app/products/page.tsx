...
const ProductsPage = () => {
  ...
  return (
    <section className='relative flex flex-col py-5 mt-20 overflow-hidden border-t-2 2xl:max-container lg:mb-10 lg:py-20 lg:mx-10 lg:px-10 xl:mb-20 md:w-full sm:w-full md:mx-0 md:px-0'>
