...
const Slider = () => {
  ...
  return (
    <div className="heroSlideImg  mr-10 flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] lg:flex-row bg-[#fcf6ef] transition-transform duration-500 ease-in-out mx-35 my-36">
      {/* TEXT CONTAINER */}
      <div
