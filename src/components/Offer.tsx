...
const Offer = () => {
  ...
  return (
    ...
    <div className="bg-black h-full flex flex-col md:flex-col md:gap-2  md:bg-[url('/offerBg.png')] lg:mx-5 rounded-2xl">
      {/* TEXT CONTAINER */}
    ...
    <div className="lg:w-[100%] md:w-[50%] rounded-lg lg:h-80 md:h-32 mx-6">
