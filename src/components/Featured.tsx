...
const Featured = () => {
  ...
  return (
    <section className='relative flex flex-col w-full h-full py-5 overflow-auto no-scrollbar 2xl:max-container lg:mb-10 lg:py-20 xl:mb-20 mt-14'>
...
<div className='flex items-start justify-start w-full h-full gap-8 px-2 mx-20 overflow-x-auto no-scrollbar'>  
    ...
    height={150} className="animate-spin bg-blend-multiply"/>
        ...
        {featuredProducts.map((item) => (
          <div
            key={item._id}
            className="rounded-md gap-14 px-5 mx-10 space-between h-[250px] w-[170px] flex flex-col items-center justify-around p-4 hover:bg-fuchsia-50 transition-all duration-300 md:w-[20vw] xl:w-[18vw] xl:h-[400px] bg-[#B78C56] shadow-[-10px_7px_0px_0px_#741102] mt-20"
          >
            {/* IMAGE CONTAINER */}
            {item.img && (
