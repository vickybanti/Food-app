...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-16 px-4 lg:px-10 xl:px-0 lg:px-0 md:px-5 sm:px-5">
        {/* Logo */}
        <div className="flex items-center">
          <Link href="/">
            <div className="w-[150px] lg:h-[90px] md:h-[45px] px-2 font-sans text-3xl font-bold md:py-3">
              <Image
                src="/logo-bg.png"
                width={60}
                height={40}
